 ...
 * In a real application, this would be provided by the C++ side
 */
export function createDispatcher(): number {
  // For testing purposes, we'll use a non-zero value
  // In a real application, this would be a proper dispatcher handle from C++
  return 1; // Non-zero value to indicate valid dispatcher
}
