...
/**
 * Filter error codes.
 * Specifies error conditions that can occur during filter processing.
 */
public enum FilterError {
     ...
     * Filter configuration is malformed or invalid.
     */
    INVALID_CONFIG(McpFilterLibrary.MCP_FILTER_ERROR_INVALID_CONFIG),
    
    /**
     * Initialization failed.
     * Filter failed to initialize properly.
     */
    ...
    public boolean isRuntimeError() {
        return this == BUFFER_OVERFLOW || this == PROTOCOL_VIOLATION || 
               this == UPSTREAM_TIMEOUT || this == CIRCUIT_OPEN || 
               this == RESOURCE_EXHAUSTED || this == INVALID_STATE;
    }
