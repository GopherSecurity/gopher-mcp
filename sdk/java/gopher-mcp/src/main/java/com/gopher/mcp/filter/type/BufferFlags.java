...
/**
 * Buffer flags for memory management.
 * Specifies buffer characteristics and access permissions.
 */
public enum BufferFlags {
    
    /**
     * Read-only buffer.
     * Buffer contents cannot be modified.
     */
    READONLY(McpFilterLibrary.MCP_BUFFER_FLAG_READONLY),
    
    /**
     * Owned buffer.
     * Buffer memory is owned by the filter.
     */
    OWNED(McpFilterLibrary.MCP_BUFFER_FLAG_OWNED),
    
    /**
     * External buffer.
     * Buffer memory is managed externally.
     */
