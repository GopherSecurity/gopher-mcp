...
/**
 * Chain state.
 * Represents the current operational state of a filter chain.
 */
public enum ChainState {
    
    /**
     * Idle state.
     * Chain is inactive and ready to process.
     */
    IDLE(McpFilterChainLibrary.MCP_CHAIN_STATE_IDLE),
    
    /**
     * Processing state.
     * Chain is actively processing data.
     */
    PROCESSING(McpFilterChainLibrary.MCP_CHAIN_STATE_PROCESSING),
    
    /**
     * Paused state.
     * Chain execution is temporarily suspended.
     */
    PAUSED(McpFilterChainLibrary.MCP_CHAIN_STATE_PAUSED),
    
    /**
     * Error state.
     * Chain encountered an error condition.
     */
    ERROR(McpFilterChainLibrary.MCP_CHAIN_STATE_ERROR),
    
    /**
     * Completed state.
     * Chain has finished processing.
     */
