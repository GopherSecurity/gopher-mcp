...
TEST_F(MCPCApiTypeHelpersTest, ContentBlockValidation) {
    ...
    mcp_resource_t resource = {
        .uri = const_cast<char*>("file:///test.txt"),
...
TEST_F(MCPCApiTypeHelpersTest, ContentBlockDeepCopy) {
    ...
    EXPECT_NE(copy->text.annotations.value.audience,
...
TEST_F(MCPCApiTypeHelpersTest, LoggingLevelToString) {
    ...
    // Invalid level
    EXPECT_STREQ(mcp_logging_level_to_string(static_cast<mcp_logging_level_t>(999)), "unknown");
}
