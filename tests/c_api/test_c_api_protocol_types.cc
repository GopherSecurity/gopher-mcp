...
TEST_F(MCPCApiProtocolTypesTest, ListResourcesResult) {
    ...
    result.resources = static_cast<mcp_resource_t*>(
        calloc(2, sizeof(mcp_resource_t)));
...
TEST_F(MCPCApiProtocolTypesTest, ListPromptsResult) {
    ...
    result.prompts = static_cast<mcp_prompt_t*>(
        calloc(2, sizeof(mcp_prompt_t)));
...
TEST_F(MCPCApiProtocolTypesTest, ListToolsResult) {
    ...
    result.tool_count = 2;
    result.tools = static_cast<mcp_tool_t*>(
        calloc(2, sizeof(mcp_tool_t)));
...
TEST_F(MCPCApiProtocolTypesTest, CallToolResult) {
    ...
    result.content_count = 2;
    result.content = static_cast<mcp_content_block_t*>(
        calloc(2, sizeof(mcp_content_block_t)));
...
TEST_F(MCPCApiProtocolTypesTest, ListRootsResult) {
    ...
    result.root_count = 2;
    result.roots = static_cast<mcp_root_t*>(
        calloc(2, sizeof(mcp_root_t)));
