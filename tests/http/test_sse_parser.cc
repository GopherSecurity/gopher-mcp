...
TEST_F(SseParserTest, MultiLineData) {
  const char* sse_stream = "data: First line\n"
                          "data: Second line\n"
                          "data: Third line\n"
                          "\n";
...
TEST_F(SseParserTest, MultipleEvents) {
  const char* sse_stream = "data: Event 1\n"
                          "\n"
                          "data: Event 2\n"
                          "\n"
                          "data: Event 3\n"
...
TEST_F(SseParserTest, Comments) {
  const char* sse_stream = ": This is a comment\n"
                          "data: Some data\n"
                          ": Another comment\n"
                          "\n";
...
TEST_F(SseParserTest, FieldWithoutColon) {
  const char* sse_stream = "invalid field\n"
                          "data: Valid data\n"
                          "\n";
...
TEST_F(SseParserTest, FieldWithColonNoSpace) {
  const char* sse_stream = "data:No space\n"
                          "\n";
...
TEST_F(SseParserTest, FieldWithLeadingSpace) {
  const char* sse_stream = "data:  Two spaces\n"
                          "\n";
...
TEST_F(SseParserTest, UnknownField) {
  const char* sse_stream = "unknown: field\n"
                          "data: Known data\n"
                          "\n";
...
TEST_F(SseParserTest, InvalidRetryValue) {
  const char* sse_stream = "retry: not_a_number\n"
                          "data: Test\n"
                          "\n";
...
TEST_F(SseParserTest, CrLfLineEndings) {
  const char* sse_stream = "data: Windows line\r\n"
                          "\r\n";
...
TEST_F(SseParserTest, CrOnlyLineEndings) {
  const char* sse_stream = "data: Mac line\r"
                          "\r";
...
TEST_F(SseParserTest, Reset) {
  const char* sse_stream1 = "id: 1\n"
                           "data: First\n"
                           "\n";
  
  const char* sse_stream2 = "data: Second\n"
                           "\n";
...
TEST_F(SseParserTest, ByteOrderMark) {
  ...
  const unsigned char sse_with_bom[] = {
  ...
  parser_->parse(reinterpret_cast<const char*>(sse_with_bom), sizeof(sse_with_bom));
}
...
TEST_F(SseParserTest, LastEventId) {
  ...
  const char* sse_stream = "id: abc123\n"
                          "data: Test\n"
                          "\n";
