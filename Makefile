...
.PHONY: all build test test-verbose test-parallel test-list check check-verbose check-parallel clean release debug help format format-ts format-python format-ruby check-format install uninstall
...
help:
	...
	@echo "│ make format        Auto-format all source files (C++, TypeScript, Python, Rust, Ruby) │"
	...
	@echo "│   $$ make format          # Format all code (C++, TypeScript, Python, Rust, Ruby) │"
