...
int main() {
    ...
    try {
        ...
        auto request = mcp::make<mcp::jsonrpc::Request>(
                mcp::make_request_id(1), "test.echo")
        ...
        std::cout << "  Has result: " << (response.result.has_value() ? "yes" : "no") << "\n";
        ...
        std::cout << "  Has params: " << (notification.params.has_value() ? "yes" : "no") << "\n";
        ...
        auto tool = mcp::ToolBuilder("calculator")
        ...
        std::cout << "  Has description: " << (tool.description.has_value() ? "yes" : "no") << "\n";
        std::cout << "  Has parameters: " << (tool.parameters.has_value() ? "yes" : "no") << "\n";
        ...
        std::cout << "  Has temperature: " << (sampling.temperature.has_value() ? "yes" : "no") << "\n";
        std::cout << "  Has maxTokens: " << (sampling.maxTokens.has_value() ? "yes" : "no") << "\n";
        std::cout << "  Has metadata: " << (sampling.metadata.has_value() ? "yes" : "no") << "\n";
