...
MCP_API mcp_result_t mcp_list_insert(mcp_list_t list, size_t index, void* item) MCP_NOEXCEPT;
...
MCP_API mcp_result_t mcp_list_remove(mcp_list_t list, size_t index) MCP_NOEXCEPT;
