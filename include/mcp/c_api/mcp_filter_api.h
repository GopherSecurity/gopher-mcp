 ...
 * enabling any language to integrate with C++ filters through a clean interface.
 * 
 * Architecture:
...
typedef mcp_filter_status_t (*mcp_filter_data_cb)(
...
typedef mcp_filter_status_t (*mcp_filter_write_cb)(
    mcp_buffer_handle_t buffer,
    mcp_bool_t end_stream,
    void* user_data
);
...
// Watermark callbacks
typedef void (*mcp_filter_watermark_cb)(
    mcp_filter_t filter,
    void* user_data
);

// Error callback
typedef void (*mcp_filter_error_cb)(
    mcp_filter_t filter,
...
typedef void (*mcp_filter_completion_cb)(
    mcp_result_t result,
    void* user_data
);

// Post completion callback
typedef void (*mcp_post_completion_cb)(
    mcp_result_t result,
    void* user_data
);

// Request callback for server
typedef void (*mcp_filter_request_cb)(
    mcp_buffer_handle_t response_buffer,
    mcp_result_t result,
    void* user_data
);
...
MCP_API mcp_result_t mcp_filter_set_callbacks(
    mcp_filter_t filter,
    const mcp_filter_callbacks_t* callbacks
) MCP_NOEXCEPT;
