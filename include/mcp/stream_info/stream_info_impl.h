...
public:
  ...
  std::chrono::steady_clock::time_point startTime() const override { return start_time_; }
  std::chrono::nanoseconds startTimeMonotonic() const override { return start_time_monotonic_; }
  optional<std::chrono::steady_clock::time_point> endTime() const override { return end_time_; }
  ...
  void setProtocol(const std::string& protocol) override { protocol_ = protocol; }
  ...
  optional<std::string> responseCodeDetails() const override { return response_code_details_; }
  void setResponseCodeDetails(const std::string& details) override { response_code_details_ = details; }
  ...
  const ResponseFlags& responseFlags() const override { return response_flags_; }
  ResponseFlags& responseFlags() override { return response_flags_; }
  
  const network::Address::InstanceConstSharedPtr& upstreamAddress() const override { return upstream_address_; }
  void setUpstreamAddress(const network::Address::InstanceConstSharedPtr& address) override { upstream_address_ = address; }
  
  const std::string& upstreamCluster() const override { return upstream_cluster_; }
  void setUpstreamCluster(const std::string& cluster) override { upstream_cluster_ = cluster; }
  ...
  const DynamicMetadata& dynamicMetadata() const override { return dynamic_metadata_; }
  ...
  static SharedPtr create() {
    return std::make_shared<StreamInfoImpl>();
  }
