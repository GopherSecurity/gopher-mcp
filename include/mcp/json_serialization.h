...
template<typename T> struct JsonSerializeTraits;
template<typename T> struct JsonDeserializeTraits;
...
template<> struct JsonSerializeTraits<std::string> {
  static JsonValue serialize(const std::string& value) { return JsonValue(value); }
};
template<> struct JsonSerializeTraits<int> {
  static JsonValue serialize(int value) { return JsonValue(value); }
};
template<> struct JsonSerializeTraits<int64_t> {
  static JsonValue serialize(int64_t value) { return JsonValue(value); }
};
template<> struct JsonSerializeTraits<double> {
  static JsonValue serialize(double value) { return JsonValue(value); }
};
template<> struct JsonSerializeTraits<bool> {
  static JsonValue serialize(bool value) { return JsonValue(value); }
};

// Deserialization traits for basic types
template<> struct JsonDeserializeTraits<std::string> {
  static std::string deserialize(const JsonValue& json) { return json.getString(); }
};
template<> struct JsonDeserializeTraits<int> {
  static int deserialize(const JsonValue& json) { return json.getInt(); }
};
template<> struct JsonDeserializeTraits<int64_t> {
  static int64_t deserialize(const JsonValue& json) { return json.getInt64(); }
};
template<> struct JsonDeserializeTraits<double> {
  static double deserialize(const JsonValue& json) { return json.getFloat(); }
};
template<> struct JsonDeserializeTraits<bool> {
...
template<> struct JsonSerializeTraits<enums::Role::Value> {
  static JsonValue serialize(enums::Role::Value value) {
    return JsonValue(enums::Role::to_string(value));
  }
};

template<> struct JsonDeserializeTraits<enums::Role::Value> {
...
template<> struct JsonSerializeTraits<enums::LoggingLevel::Value> {
  static JsonValue serialize(enums::LoggingLevel::Value value) {
    return JsonValue(enums::LoggingLevel::to_string(value));
  }
};

template<> struct JsonDeserializeTraits<enums::LoggingLevel::Value> {
...
// Implementation type
template<> struct JsonSerializeTraits<Implementation> {
...
template<> struct JsonDeserializeTraits<Implementation> {
...
// Metadata type
template<> struct JsonSerializeTraits<Metadata> {
  static JsonValue serialize(const Metadata& metadata) {
    JsonObjectBuilder builder;
    for (const auto& kv : metadata) {
      match(kv.second,
        [&](std::nullptr_t) { builder.addNull(kv.first); },
...
template<> struct JsonDeserializeTraits<Metadata> {
  static Metadata deserialize(const JsonValue& json) {
    Metadata metadata;
    if (!json.isObject()) return metadata;
