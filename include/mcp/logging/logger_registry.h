...
private:
  ...
  std::unordered_map<Component, 
                     std::unordered_map<std::string, std::shared_ptr<Logger>>> component_loggers_;
  ...
  // static thread_local std::unordered_map<std::string, std::shared_ptr<Logger>> tls_cache_;
