...
public:
  ...
  std::string sslPeerCertificate() const override { return ssl_peer_certificate_; }
  ...
  void restoreLocalAddress(const Address::InstanceConstSharedPtr& address) override;
  bool localAddressRestored() const override;
  void setRemoteAddress(const Address::InstanceConstSharedPtr& address) override;
