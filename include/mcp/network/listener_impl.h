 ...
 * @brief Simplified production-grade listener following industrial best practices
 *
...
class UnitFloat {
public:
  UnitFloat(float value = 0.0f) : value_(std::max(0.0f, std::min(1.0f, value))) {}
...
public:
  ...
  // Accessors
  const Address::InstanceConstSharedPtr& localAddress() const { return local_address_; }
