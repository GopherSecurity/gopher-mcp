...
using SocketOptionsSharedPtr = std::shared_ptr<std::vector<SocketOptionConstSharedPtr>>;
...
public:
  virtual void setLocalAddress(const Address::InstanceConstSharedPtr& address) = 0;
  virtual void restoreLocalAddress(const Address::InstanceConstSharedPtr& address) = 0;
  virtual bool localAddressRestored() const = 0;
  
  virtual void setRemoteAddress(const Address::InstanceConstSharedPtr& address) = 0;
